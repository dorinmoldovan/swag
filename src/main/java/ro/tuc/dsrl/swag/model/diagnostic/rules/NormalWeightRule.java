 ...
 */
@JRDefinition
public interface NormalWeightRule extends WeightRulePrefix {

	@JRInput(value = "ge")
	void method5(@JRParameter(value = "b") Object arg0, @JRParameter(value = "18.5") Double arg1);

	@JRInput(value = "lessThan")
	void method6(@JRParameter(value = "b") Object arg0, @JRParameter(value = "25.0") Double arg1);

	@JROutput(value = "hasDiagnostic")
	void method7(@JRParameter(value = "x") Object arg0, @JRParameter(value = "NormalWeight") Diagnostic arg1);
